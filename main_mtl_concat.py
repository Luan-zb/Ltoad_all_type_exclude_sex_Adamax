...
if args.task == 'dummy_mtl_concat':
    ...
    '''
    dataset = Generic_MIL_MTL_Dataset(csv_path = 'dataset_csv/CM_LSCC_Processed_Augmentation.csv',
...
if args.split_dir is None:
    args.split_dir = os.path.join('splits_LSCC_CM_Augmentation', args.task+'_{}'.format(int(100)))
else:
    args.split_dir = os.path.join('splits_LSCC_CM_Augmentation', args.split_dir)
