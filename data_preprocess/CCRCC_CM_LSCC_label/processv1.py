import pandas as pd
import numpy as np
result_csv=pd.read_csv("cohort_LSCC_CM_CCRCC.csv")
...
data2=data[data.Specimen_Type.isin(['tumor_tissue'])]
print(data2.shape[0])
print(data2)
data2.to_csv("processedv1.csv",index=False,columns=['Case_ID','Slide_ID','Topographic_Site'])
