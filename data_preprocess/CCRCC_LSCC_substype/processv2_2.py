...
data=data[data['Tumor_Histological_Type'].str.contains('squamous cell carcinoma')==True]
data['Tumor_Histological_Type']='LSCC'
print(data)

data.to_csv("processedv2_2.csv",index=False,columns=['Case_ID','Slide_ID','Tumor_Histological_Type','Gender','Tumor_Site'])
