...
if args.task == 'study_v2_mtl_sex':
    args.n_classes = 8
    dataset = Generic_MIL_MTL_Dataset(csv_path='dataset_csv/one_wsi_exclude_sex.csv',
                                      data_dir=os.path.join(args.data_root_dir,'/home/daichuangchuang/Nature/Lclam/FEATURES_DIRECTORY_one_wsi/pt_files'),
                                      shuffle=False,
                                      print_info=True,
